...
(function (global, factory) {
  ...
  Parsley.addMessages('en', {
    ...
    type: {
      ...
      number: "این مقدار باید یک شماره معتبر باشد.",
      integer: "این مقدار باید یک عدد صحیح معتبر باشد.",
      digits: "این مقدار باید یک رقم معتبر باشد.",
      alphanum: "این مقدار باید الفبایی معتبر باشد."
    },
    notblank: "این مقدار نباید خالی باشد.",
    required: "این مقدار الزامی است.",
    pattern: "این مقدار به نظر میرسد نامعتبر است.",
    min: "این مقدار باید بیشتر یا برابر با %s باشد.",
    max: "این مقدار باید کمتر یا برابر باشد با %s باشد.",
